...
class ResourcesPostTest extends OperationsBaseTest {
  ...
  void operationType() {
    ...
    Assertions.assertEquals(OperationType.POST, resourcePost.operationType());
  }

  @Test
  void isEnabledTrueWhenInsertable() {
    ResourcesPost resourcePost = new ResourcesPost(metaResource);
    Assertions.assertTrue(metaResource.isInsertable());
  ...
  void getDescription() {
    ResourcesPost resourcePost = new ResourcesPost(metaResource);
    Assertions.assertEquals("Create a ResourceName", resourcePost.getDescription());
  }
  ...
  void getDescriptionWhenRepositoryIsBulk() {
    ...
    ResourcesPost resourcePost = new ResourcesPost(metaResource);
    Assertions.assertEquals("Create one (or more) ResourceName", resourcePost.getDescription());
  }

  @Test
  void operation() {
    Operation operation = new ResourcesPost(metaResource).operation();
    Assertions.assertTrue(operation.getResponses().containsKey("201"));
  }
