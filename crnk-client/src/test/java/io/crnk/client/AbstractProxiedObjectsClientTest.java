...
public abstract class AbstractProxiedObjectsClientTest extends AbstractClientTest {
    ...
    public void noProxyForLazy() {
        ...
        Assertions.assertNull(proxiedObject);
    ...
    public void noproxyForIdFieldAndSerializedId() {
        ...
        Assertions.assertNull(proxiedObject);
        Assertions.assertEquals(Long.valueOf(2L), schedule.getProjectId());
    }
    ...
    public void proxyForSerializedIdWithoutRelationId() {
        ...
        Assertions.assertNotNull(proxiedObject);
        Assertions.assertEquals(2L, proxiedObject.getId().longValue());
        Assertions.assertNull(proxiedObject.getName());
    }
    ...
    public void noProxyForEager() {
        ...
        Assertions.assertNotNull(proxiedObject);
        Assertions.assertEquals(2L, proxiedObject.getId().longValue());
        Assertions.assertNotNull(proxiedObject.getDescription());
    ...
    public void saveDoesNotTriggerLazyLoad() {
        ...
        Assertions.assertFalse(proxy.isLoaded());
        Assertions.assertSame(proxy, schedule.getTasks());

        // data should be saved
        schedule = scheduleRepo.findOne(1L, querySpec);
        Assertions.assertEquals("newValue", schedule.getName());
    }
