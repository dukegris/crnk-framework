...
/*
RCS corresponde a Spring boot2
...
public class BasicSpringBoot1Test {
	...
	// RCS corresponde a Spring boot2
	// @Autowired
	// FacetModuleConfigurer facetModuleConfigurer;

	// RCS corresponde a Spring boot2
	// @Autowired
	// CrnkFacetProperties facetProperties;

	// RCS corresponde a Spring boot2
	// @Autowired
	// PlainJsonFormatProperties plainJsonFormatProperties;
